        ...
        messages.add(
            new Message(
                ...
                String.format(
                    ...
                    # 행동 규칙
                    - 감정 표현에 대해서는 판단 없이 사실적으로 확인합니다.
                    - 사용자가 조언, 판단, 방향 제시를 요청한 경우에 한해
                      작성된 내용에서 벗어나지 않는 범위 내에서
                      현실적이고 실행 가능한 가이드를 간결하게 제시합니다.
                    - 조언은 감정 해석이나 공감을 중심으로 하지 않고,
                      상황 정리, 선택지 정렬, 기준 제시에 초점을 둡니다.
